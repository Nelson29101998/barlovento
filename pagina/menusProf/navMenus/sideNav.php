...
<div id="mySidenav" class="sidenav">
    ...
    <?php
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusProf/menu.php") {
    ?>
        <a href="../menu.php">
    ...
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusProf/asistenciaAdm/asistencia.php") {
        if ($_SERVER["REQUEST_URI"] == "/centroBarlovento/pagina/menusProf/menu.php") {
            echo '<a href="asistenciaAdm/asistencia.php">';
        } else if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusProf/menu.php") {
            echo '<a href="../asistenciaAdm/asistencia.php">';
        }
    ?>
        <button type="button" class="btn btn-primary">
    ...
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusProf/arreglar/fichaDeParticipante.php") {
        if ($_SERVER["REQUEST_URI"] == "/centroBarlovento/pagina/menusProf/menu.php") {

...
<div id="mySidenav" class="sidenav">
    ...
    <?php
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusUser/menu.php") {
    ?>
        <a href="../menu.php">
    ...
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusUser/asistencia/asistencia.php") {
        if ($_SERVER["REQUEST_URI"] == "/centroBarlovento/pagina/menusUser/menu.php") {
            echo '<a href="asistencia/asistencia.php">';
        } else if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusUser/menu.php") {
            echo '<a href="../asistencia/asistencia.php">';
        }
    ?>
        <button type="button" class="btn btn-primary">

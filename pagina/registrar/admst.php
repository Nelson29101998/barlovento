    ...
    <div class="container">
        ...
        <div class="animate__animated animate__backInLeft">
            <div id="formColor" class="container">
                <br>
                <form id="formCuenta" name="formCuenta" method="post" onsubmit="return abrirCuentaAdmn()"
                    action="../buscando/buscarAdm.php">
                    <table>
                        <tbody>
                            <tr class="form-group">
                                <th>
                                ...
                                <th>
                                    <input type="text" class="form-control" name="admn" id="admn"
                                        placeholder="Ingresa en Usuario">
                                </th>
                            </tr>
                            <tr class="form-group">
                                <th>
                                ...
                                <th>
                                    <input type="password" class="form-control" name="contrs" id="contrs"
                                        placeholder="Ingresa en la conteaseña">
                                </th>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="text-center">
                        ...
                        <button onclick="javascript:history.back()" class="btn btn-primary" type="button"

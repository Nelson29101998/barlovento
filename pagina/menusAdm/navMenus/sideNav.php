...
<div id="mySidenav" class="sidenav">
    ...
    <?php
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusAdm/menu.php") {
    ?>
        <a href="../menu.php">
    ...
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusAdm/asistenciaAdm/asistencia.php") {
        if ($_SERVER["REQUEST_URI"] == "/centroBarlovento/pagina/menusAdm/menu.php") {
            echo '<a href="asistenciaAdm/asistencia.php">';
        } else if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusAdm/menu.php") {
            echo '<a href="../asistenciaAdm/asistencia.php">';
        }
    ?>
        <button type="button" class="btn btn-primary">
    ...
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusAdm/arreglarAdm/fichaDeParticipante.php") {
        if ($_SERVER["REQUEST_URI"] == "/centroBarlovento/pagina/menusAdm/menu.php") {
    ...
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusAdm/profesorAdm/profesor.php") {
        if ($_SERVER["REQUEST_URI"] == "/centroBarlovento/pagina/menusAdm/menu.php") {
    ...
    if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/menusAdm/listaEstd/listaEstudiante.php") {
        if ($_SERVER["REQUEST_URI"] == "/centroBarlovento/pagina/menusAdm/menu.php") {
            echo '<a href="listaEstd/listaEstudiante.php">';
        } else if ($_SERVER["REQUEST_URI"] !== "/centroBarlovento/pagina/listaEstd/listaEstudiante.php") {
            echo '<a href="../listaEstd/listaEstudiante.php">';
        }
    ?>
        <button type="button" class="btn btn-primary">
